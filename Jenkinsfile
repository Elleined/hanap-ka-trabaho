pipeline {
    ...
    stages {
        stage("Clone Hanap Ka Trabaho API from Github") {
            steps {
                echo "Cloning Hanap Ka Trabaho API from Github. Please Wait..."
                git branch: 'main',
                    url: 'https://github.com/Elleined/physioave-management-system.git'
                echo "Cloning Hanap Ka Trabaho API from Github. Success!"
            }
        }
        ...
        stage("Create Docker Image") {
            steps {
                ...
                sh 'docker build -t elleined/hanap-ka-trabaho:latest .'
        ...
        stage("Push docker image to DockerHub") {
            steps {
                ...
                sh 'docker push elleined/hanap-ka-trabaho:latest'
